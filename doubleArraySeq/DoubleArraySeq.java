 ...
 * 
 * program that contains the methods needed to create the DoubleArraySeq.   Creats, clones, adds elements (before of after current element), deletes elements, and turns them into 
...
public DoubleArraySeq( )
{
   // Implemented by student.
	...
	final int INITITIAL_CAPACITY = 10;
	data = new double[INITITIAL_CAPACITY];
...
public static DoubleArraySeq catenation(DoubleArraySeq s1, DoubleArraySeq s2)
{
   // Implemented by student.
	...
	//change s1 and s2 from ints to doubles look in intarrybag
